...
template <typename T>
class StudentManagement : public Student<T>
{
public:
    // ADD STUDENT
    void addStudent()
...
int main()
{
    StudentManagement<string> student_management;

    int choice;

    do
    {
        cout <<endl<< "Student Management System";
        cout <<endl<< "-------------------------";
        cout <<endl<< "Press 1 for Add Student";
        cout <<endl<< "Press 2 for Display Students";
        cout <<endl<< "Press 3 for Remove Student";
        cout <<endl<< "Press 4 for Search Student";
        cout <<endl<< "Press 5 for Exit";
        ...
        {
        case 1:
            student_management.addStudent();
            break;
        case 2:
            student_management.displayAllStudents();
            break;
        case 3:
            student_management.removeStudentById();
            break;
        case 4:
            student_management.searchStudentById();
            break;
        case 5:
            cout << "Exiting.."<<endl;
            break;
